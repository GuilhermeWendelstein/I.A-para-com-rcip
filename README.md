...
- Analisar um dataset de e-commerce;
...
Uma das principais dificuldades pode ser a qualidade e quantidade dos dados. Caso o dataset seja pequeno ou tenha muitos dados incompletos, o modelo pode gerar recomendações menos precisas.
